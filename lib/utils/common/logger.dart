...
class LogEntity {
  ...
  @override
  String toString() {
    return '${UtilFormatter.dateTimeToString(time)}$_infoIndicator${_logLevelToString(level)}$_infoIndicator$filePath$_infoIndicator$screen$_infoIndicator$method$_infoIndicator$line$_messageIndicator$message';
  }
  ...
  factory LogEntity.fromString(String log) {
    ...
    return LogEntity(
      time: UtilFormatter.stringToDateTime(logInfos[0]),
